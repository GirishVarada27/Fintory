...
export default function Privacy() {
  return (
    <div className={`max-w-none space-y-4 ${cardClass}`}>
      ...
      <h2 className="text-lg font-semibold text-slate-900 dark:text-white">What we store</h2>
      ...
      <h2 className="text-lg font-semibold text-slate-900 dark:text-white">How we protect it</h2>
      <ul className="list-disc space-y-1 pl-6 text-slate-700 dark:text-slate-300">
      ...
      <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Third parties</h2>
      <p className="text-slate-700 dark:text-slate-300">
